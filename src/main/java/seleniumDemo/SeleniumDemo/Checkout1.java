...
public class Checkout1 {
    ...
    public void testClickEachLink() {
        ...
        System.out.println("Total number of unique links on the main page: " + uniqueLinksOnMainPage.size());
        ...
        for (String linkUrl : uniqueLinksOnMainPage) {
            ...
            // Re-find the links after navigating back to avoid StaleElementReferenceException
        ...
        int specificLinkIndex = 0;

        if (specificLinkIndex >= 0 && specificLinkIndex < links.size()) {
            ...
            // Handle StaleElementReferenceException by retrying the click operation
            int maxAttempts = 3;
            int attempt = 0;
            ...
            for (String linkUrl : uniqueLinksOnSpecificPage) {
                ...
                // Re-find the links after navigating back to avoid StaleElementReferenceException
                linksOnSpecificPage = driver.findElements(By.tagName("a"));
